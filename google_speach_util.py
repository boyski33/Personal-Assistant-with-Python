...
class gTTS(object):
    ...
    def __init__(self, text='initializer', lang='en', debug=False):
        self.debug = debug
        ...
        for idx, part in enumerate(self.text_parts):
            ...
            try:
                ...
                if self.debug:
                    ...
                    print("Reponse: {}, Redirects: {}".format(r.status_code,
                                                              r.history))
                r.raise_for_status()
    ...
    def read_given_string(self, passed_string):
        """
        Method to play the recorded mp3.
        :param passed_string:
        :return:
        """
        testRun = gTTS(text=passed_string)
        testRun.save('gtts_response.mp3')
        sound = pyglet.media.load('/home/ventsislav/python_hfmi/'
